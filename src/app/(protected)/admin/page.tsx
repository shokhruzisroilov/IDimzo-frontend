...
export default function AdminDashboard() {
  ...
  const stats = [
    { title: "Количество контрактов", count: 4, time: "объявлено 5 мин назад", bgColor: "bg-yellow-400", icon: LayoutDashboard },
    { title: "Дата окончания срока", count: 3, time: "объявлено через 10 дней", bgColor: "bg-blue-400", icon: BookOpen },
    { title: "Растрогнутый контракт", count: 1, time: "объявлено 5 дней назад", bgColor: "bg-blue-400", icon: FileText },
    { title: "В процессе", count: 1, time: "объявлено 15 мин назад", bgColor: "bg-yellow-400", icon: User },
  ];
